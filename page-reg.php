...
?>
   ...
   /*         if($(this).is(":checked")){
    ...
    <br>
    <br>
    <form action="<?php echo get_template_directory_uri();?>/bddteam_act<?php echo $target?>.php" method="POST" id="addteam_form" enctype="multipart/form-data">
